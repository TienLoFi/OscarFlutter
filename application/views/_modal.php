<!-- SignIn Modal -->
<form id="form_signin" action="<?php echo base_url();?>/admin/auth/signIn" method="post">
<div id="signin-modal" class="modal fade bs-example-modal-sm" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="form-group">
						<div><a href="#" data-dismiss="modal" data-toggle="modal" data-target="#forget-modal">Forgot Password?</a></div>
						</div>
					</div>
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default waves-effect" data-dismiss="modal" data-toggle="modal" data-target="#signup-modal">Sign Up</button>
...
<form id="form_verify" action="<?php echo base_url();?>/admin/auth/userVerify" method="post">
...
<div id="change-modal" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id="form_changeMyProfile" action="<?php echo base_url();?>/admin/changeMyProfile" method="post">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group">
								<label for="field-1" class="control-label">Name</label>
								<input type="text" class="form-control" id="user_name" name="name" value="<?php echo !empty($user)?$user['name'] : ''?>" placeholder="Your Name">
							</div>
						</div>							
					</div>
					<div class="row">
						<div class="col-xs-12">
							<div class="form-group">
								<label for="field-1" class="control-label">Email</label>
								<input type="text" class="form-control" id="user_email" name="email" value="<?php echo !empty($user)?$user['email'] : ''?>" placeholder="Your Email">
							</div>
						</div>							
					</div>
				</div>
			...
			<form id="form_changePwd" action="<?php echo base_url();?>/admin/changeUserPassword" method="post">
				<div class="modal-header">
