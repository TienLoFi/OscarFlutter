...
<html>
    <head>
        ...
        <link href="<?php echo base_url()?>assets/js/chosen/chosen.min.css" rel="stylesheet" type="text/css" />
        <script src="<?php echo base_url()?>assets/js/modernizr.min.js"></script>

    </head>

	<body style="padding-bottom:0">
		<div id="wrapper"> <div class="content-page" style="margin:0"> <div class="content" style="margin:0">