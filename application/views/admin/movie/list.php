...
<input type="hidden" id="award-movie-page-admin" value="1">
<!-- content -->
<div class="ballot-content" style="padding-top:25px; padding-bottom:20px">
	<div style="width:100%;text-align:center;background: #fafafa;margin-top: 5px;padding-top: 5px;padding-bottom: 5px;">
		<button type="button" data-toggle="modal" data-target="#add-edit-movie-modal" class="btn btn-success waves-effect w-md waves-light m-b-5"  id="add-movie-btn">ADD MOVIE</button>
	...
	<div class="table-responsive b-0">
		<form method="get" accept-charset="utf-8" action="<?php echo base_url()?>admin/movie/index">
			<div class="row">
				<div class="col-sm-6">
                ...
                <?php foreach ($list as $item):?>
                    ...
                    <tr class="gradeX">
                        ...
                        <td class="actions">
                            ...
                            <a href="#" class="on-default remove-row" style="color: red;" onclick="onDeleteMovie('<?php echo $item['id']; ?>')"><i class="fa fa-trash-o"></i></a>
							<a href="#" class="on-default edit-row" style="color: white;" data-toggle="modal" data-target="#add-edit-movie-modal" onclick="onEditMovie('<?php echo $item['id']; ?>')"><i class="fa fa-edit"></i></a>
                        </td>
                    </tr>	
                    <?php endif;?>
                <?php endforeach ?>		
...
<!-- footer -->
<div id="add-edit-movie-modal" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
		<div class="modal-content" id="add-edit-movie-content">
		</div>
	</div>
</div>
