...
<table class="table table-striped">
    ...
    <?php foreach($members as $member):?>
        <tr class="gradeX">
            <td><input type="checkbox" class="member_checkbox" value="<?php echo $member->id;?>"></td>
            <td><?php echo $member->name;?></td>
            <td><?php echo $member->email;?></td>
            <td><?php echo $member->score;?></td>
            <td><?php echo $member->status == 1?'Active' : 'Pending';?></td>
            <td class="actions">
                <a href="#" class="on-default remove-row remove-member" style="color: red;" data-id="<?php echo $member->id;?>"><i class="fa fa-trash-o"></i></a>
            </td>
        </tr>
    <?php endforeach;?>
    </tbody>
